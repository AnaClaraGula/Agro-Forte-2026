...
📌 Sobre o Projeto
O projeto “Campo Forte, Planeta Sustentável” Este projeto é um site educativo que mostra como o agronegócio pode produzir alimentos de forma eficiente e, ao mesmo tempo, preservar o meio ambiente. O site apresenta informações sobre práticas sustentáveis, como o uso de energia solar, rotação de culturas e agricultura de precisão.

Além disso, possui um quiz interativo para testar os conhecimentos dos visitantes e um botão de acessibilidade que aumenta o tamanho das letras, tornando a navegação mais inclusiva.


🎯 Objetivo
O objetivo do projeto é conscientizar sobre a importância de unir tecnologia, produtividade e sustentabilidade para garantir um futuro melhor para o campo e para a sociedade. 🌱🚜🌍
